...
export class FollowService {
	...
	public async unsubscribe(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
		...
		await this.memberService.memberStatsEditor({ _id: followerId, targetKey: 'emberFollowings', modifier: -1 });
		await this.memberService.memberStatsEditor({ _id: followingId, targetKey: 'emberFollowers', modifier: -1 });
